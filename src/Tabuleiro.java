        ...
        if(this.jogadores.size() < 6) {
            ...
            do {
                ...
                for (int i = 0; i < jogadores.size(); i++) {
                    if (jogadores.get(i).getCor().equalsIgnoreCase(cor)) {
                        corUsada = true;
                        break;
                    }
                }
            ...
            while (jogadores.size() < 2) {
                ...
                do {
                    ...
                    for (int i = 0; i < jogadores.size(); i++) {
                        if (jogadores.get(i).getCor().equalsIgnoreCase(corDiferente)) {
                            corUsada = true;
                            break;
                        }
                    }
                    ...
                    if (this.jogadores.get(i).getCasaAtual() == 17 || this.jogadores.get(i).getCasaAtual() == 27) {
                        ...
                        do{
                            ...
                            if (this.jogadores.get(i).getCor().equalsIgnoreCase(corEscolhida)) {
                                ...
                                for (int j = 0; j < this.jogadores.size(); j++) {
                                    if (this.jogadores.get(j).getCor().equalsIgnoreCase(corEscolhida)) {
                     ...
                     // Casa Especial Mudança Com a Menor Casa
